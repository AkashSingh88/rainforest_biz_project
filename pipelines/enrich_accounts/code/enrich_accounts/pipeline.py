...
def pipeline(spark: SparkSession) -> None:
    ...
    df_join_account_opportunity = join_account_opportunity(spark, df_salesforce_Account, df_byAccount)
    df_join_account_opportunity = df_join_account_opportunity.cache()
    enriched_accounts(spark, df_join_account_opportunity)
